...
export default function Home() {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: `linear-gradient(to right, rgba(0, 0, 0, 0.2) 0%, transparent 100%), url(https://res.cloudinary.com/dyoht5hxt/image/upload/f_auto,q_auto,w_500,h_400,c_fill/v1780460184/background_zbrr9a.jpg)`,
